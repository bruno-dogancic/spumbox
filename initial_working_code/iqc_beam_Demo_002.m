% -------------------------------------------------------------------------
%
% IQC-toolbox: Version 2.00
% Copyright:   This is copyrighted material owned by SENER Aeroespacial
%              S.A. and J. Veenman. Usage and distribution is only
%              permitted with a licence and an explicit written consent.
% Author:      J.Veenman
% Date:        17-01-2020
% 
% -------------------------------------------------------------------------
...
for j = 1:length(l)
    for i = 1:length(alpha)
        ...
        switch p
            case 1
                perf        = iqcdelta('perf','ChannelClass','P','InputChannel',3:4,'OutputChannel',3:4,'PerfMetric','L2');
                Delta       = {udelta,perf};
            case 2
                perf        = iqcdelta('perf','ChannelClass','P','InputChannel',3:4,'OutputChannel',3:4,'PerfMetric','H2');
                Delta       = {udelta,perf};
            case 3
                Delta       = udelta;
        end           
