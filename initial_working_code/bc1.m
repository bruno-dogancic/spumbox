...
% nb = 5; % number of beams
nb = 10; % number of beams

ns = nb + nb -1; % number of systems (beams and springs between)

nd = 10;% % number of discretizations
% x = [nd, 9, 8, 7, 7, 5, 5, 4, 3, 2];% nb = 5
% x = [7, 7, 6, 5, 5, 4, 3, 3, 2, 1];% nb = 10, LMIlab 668dv, gamma = 0.066007check,10s
x = [6, 6, 5, 4, 4, 3, 3, 3, 2, 1];% nb = 10, LMIlab 530dv, gamma = 0.066182 check, 5s (Mre LMIlab 4280dv, gamma = 0.066182, 1034s) (Mr Lmilab 4280dv, gamma = 0.066182, 1264s)

msord = 20; % maximum order of the reduced subsystems
% y = [4, 3, 3, 2, 2, 2, 2, 2, 2, 2]; % nb = 10
y = [4, 3, 3, 2, 2, 2, 1, 1, 1, 1]; % nb = 10


% Vector for choosing orders of W1
z = [3, 3, 2, 2, 2, 2, 1, 1, 1, 1];% % nb = 10

% Vector for choosing orders of Wz
zz = [0, 3, 2, 2, 2, 2, 2, 2, 2, 1];% nb = 10

% Vector for choosing orders of Ww
zw = [0, 3, 2, 2, 2, 2, 2, 2, 1, 1];% nb = 10
...
[beam_ss_list,~, beam_min_lista, ~] = sdb1(nd); % series of discretized beams
...
de = iqcassign(de,'ultid','Length',1,'PoleLocation',-1, 'BasisFunctionType',1);
